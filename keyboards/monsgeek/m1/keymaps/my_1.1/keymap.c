...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [WIN_BE] = LAYOUT_all( /* Base */
        KC_ESC,              KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,   KC_F7,   KC_F8,   KC_F9,   KC_F10,    KC_F11, KC_F12,   KC_DEL,           KC_MUTE,
        KC_GRV,              KC_1,    KC_2,    KC_3,    KC_4,    KC_5,    KC_6,    KC_7,    KC_8,    KC_9,    KC_0,      KC_MINS,KC_EQL,   KC_BSPC,          KC_HOME,
        KC_TAB,              KC_Q,    KC_W,    KC_E,    KC_R,    KC_T,    KC_Y,    KC_U,    KC_I,    KC_O,    KC_P,      KC_LBRC,KC_RBRC,  KC_BSLS,          KC_PGUP,
        LT(WIN_CC, KC_CAPS), KC_A,    KC_S,    KC_D,    KC_F,    KC_G,    KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN,   KC_QUOT,KC_NUHS,  KC_ENT,           KC_PGDN,
    ...
    [WIN_FN] = LAYOUT_all( /* Fn */
        ...
        KC_TRNS, _______, _______, _______, _______, _______, _______, _______, _______, RGB_TOG, _______, _______, RGB_MOD, RGB_HUI,           _______,
        _______, _______, _______, _______, KC_CALC, _______, _______, _______, KC_MUTE, KC_VOLD, KC_VOLU, _______,          _______,  RGB_VAI, _______,
        _______, GU_TOGG, _______,                   _______,                            _______, KC_TRNS, _______,          RGB_SAD,  RGB_VAD, RGB_SAI),

    [WIN_CC] = LAYOUT_all( /* Custom 1 - arrow keys, macros and more */
        ...
        KC_TRNS, _______, KC_LWIN, KC_LCTL, KC_LSFT, KC_TAB,  KC_LALT, KC_LEFT, KC_DOWN, KC_RGHT, _______, _______, _______, _______,          _______,
        _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,          _______, _______, _______,
        _______, _______, _______,                   _______,                            _______,MO(WIN_FN),_______,         _______, _______, _______),
};
...
const uint16_t PROGMEM encoder_map[][NUM_ENCODERS][NUM_DIRECTIONS] = {
    [WIN_BE] = { ENCODER_CCW_CW(KC_VOLU, KC_VOLD) },
    [WIN_FN] = { ENCODER_CCW_CW(RGB_VAI, RGB_VAD) },
    [WIN_CC] = { ENCODER_CCW_CW(RGB_VAI, RGB_VAD) }
};
#endif
